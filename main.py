...
class CycleModel(LightningModule):
    def __init__(self, model_a_name_or_path, task_a, data_a, data_b, model_b_name_or_path=None, task_b=None, batch_size=32):
        ...
        if task_a.upper() == 'CAUSAL_LM':
            ...
            self.model_a = AutoModel.from_pretrained(model_a_name_or_path)
        else:
        ...
        if task_b.upper() == 'CAUSAL_LM':
            ...
            self.model_b = AutoModel.from_pretrained(model_b_name_or_path)
        else:
    ...
    def _cycle(self, batch, generating_model, training_model, generating_tokenizer, training_tokenizer):
        ...
        # training_ids, training_mask = training_tokenizer.batch_encode_plus(decoded_ids, padding=True, return_tensors='pt').values()
        ...
        labels[labels==generating_tokenizer.pad_token_id] = -100
