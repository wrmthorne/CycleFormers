...
from .utils import _map_and_unflatten, _tree_flatten

_ITERATOR_RETURN = Tuple[Any, int, int]  # batch, batch_idx, dataloader_idx
_DictKey = TypeVar("_DictKey")


# https://github.com/Lightning-AI/pytorch-lightning/blob/master/src/lightning/fabric/utilities/types.py
@runtime_checkable
...
# https://github.com/Lightning-AI/pytorch-lightning/blob/master/src/lightning/fabric/utilities/data.py
...
class CombinedLoader(Iterable):
    ...
    def __next__(self) -> _ITERATOR_RETURN:
        ...
        # TODO: More thoroughly remove this feature as it is unneeded and undesired
        # Modified to remove batch_idx and dataloader_idx for cleanliness in trainer
